...
class TestCommentCreation(TestCase):
    ...
    def test_anonymous_user_cant_create_comment(self):
        """Проверка что аноним не может комментить."""
    ...
    def test_user_can_create_comment(self):
        """Проверяем, что авторизованный клиент может комментить."""
    ...
    def test_user_cant_use_bad_words(self):
        """Проверка запрета плохих слов в комментах."""
...
class TestCommentEditDelete(TestCase):
    """Класс для проверки редактирования и удаления комментов."""
    ...
    def setUpTestData(cls):
        ...
        cls.url_to_comments = news_url + '#comments'  # Адрес блока с коммент.
    ...
    def test_author_can_delete_comment(self):
        """Проверка что авто может удалить коммент."""
    ...
    def test_author_can_edit_comment(self):
        """Проверка, что автор может редачить свой коммент."""
    ...
    def test_user_cant_edit_comment_of_another_user(self):
        """Проверка что читатель не может редактировать чужой коммент."""
    ...
    def test_user_cant_delete_comment_of_another_user(self):
        """Проверка, что читатель не может удалить.
